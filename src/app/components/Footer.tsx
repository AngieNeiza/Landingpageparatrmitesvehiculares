    ...
    <footer className="bg-primary-dark text-white">
      <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-text-soft">
              <li className="flex items-start gap-2">
                ...
                <a href="https://wa.me/573132871452" target="_blank" className="hover:text-white transition-colors">
                  +57 313 287 1452
                </a>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-text-soft">
